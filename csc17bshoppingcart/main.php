...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="login">
                <div id="loginSignupBtn">
                    ...
                    <a id="adminMenu" onclick="displayAdmin()">Admin</a>
                </div>
                ...
                <div id="adminLoginContent">
                    <h1>Admin</h1>
                    <div id="adminLoginFormCont">
                        <form action="adminLogin.php" id="adminLoginForm" method="post">
                            <span id="adminLoginErrormsg" class="errormsg">
                            </span>
                            <input type="text" placeholder="Email" name="email" id="adminEmailAddress"><br>
                            <br><input type="password" placeholder="Password" name="password" id="adminPassword"><br><br>
                        </form>
                        <a id="adminLoginBtn" onclick="adminLoginCheck()">Login</a>
                    </div>
                </div>
        ...
        // set the check out btn
        echo '<script type="text/javascript">';
        if($_COOKIE["user_cart"]=="[]"){
            echo 'document.getElementById("checkOut").classList.add("outOfStock");';
        }else{
            echo 'document.getElementById("checkOut").classList.remove("outOfStock");';
        }
        echo '</script>';
